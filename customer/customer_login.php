<div class="box"><!-- box Begin -->
  ...
  <center><!-- center Begin -->
     ...
     <a href="customer_register.php">
         ...
         <h3> Don't have account yet..? Register here </h3>
...
if(isset($_POST['login'])){
    ...
    $select_customer = "SELECT * FROM customers WHERE CustomerEmail='$customer_email' AND CustomerPass='$customer_pass'";
    ...
    $select_cart = "SELECT * FROM cart WHERE IpAdd='$get_ip'";
