                        ...
                        <tbody><!-- tbody begin -->
                            ...
                            <?php 
                                ...
                                while($row_p_cats=mysqli_fetch_array($run_p_cats)){
                                    ...
                                    $per_cat_id = $row_p_cats['PerCatID'];
                                    
                                    $per_cat_name = $row_p_cats['PerCatName'];
                                    
                                    $per_cat_desc = $row_p_cats['PerCatDesc'];
                            ...
                            <tr><!-- tr begin -->
                                <td> <?php echo $i; ?> </td>
                                <td> <?php echo $per_cat_name; ?> </td>
                                <td width="300"> <?php echo $per_cat_desc; ?> </td>
                                <td> 
                                    <a href="index.php?edit_per_cat= <?php echo $per_cat_id; ?> ">
                                        <i class="fas fa-pencil-ruler"></i> Edit
                                    </a>
                                </td>
                                <td> 
                                    <a href="index.php?delete_per_cat= <?php echo $per_cat_id; ?> ">
