                        ...
                        <tbody><!-- tbody begin -->
                            ...
                            <?php 
                                ...
                                while($row_c=mysqli_fetch_array($run_c)){
                                    ...
                                    $c_name = $row_c['CustomerName'];
                                    
                                    $c_img = $row_c['CustomerImg'];
                                    
                                    $c_email = $row_c['CustomerEmail'];
                                    
                                    $c_city = $row_c['CustomerCity'];
                                    
                                    $c_address = $row_c['CustomerAddress'];
                                    
                                    $c_contact = $row_c['CustomerContact'];
                            ...
                            <tr><!-- tr begin -->
                                ...
                                <td> <img src="../customer/customer_img/<?php echo $c_img; ?>" width="60" height="60"></td>
