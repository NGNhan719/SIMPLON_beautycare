...
<div class="row"><!-- row 2 begin -->
    <div class="col-lg-12"><!-- col-lg-12 begin -->
        <div class="card"><!-- panel panel-default begin -->
            <div class="card-header"><!-- panel-heading begin -->
               <h3 class="card-title"><!-- panel-title begin -->
                        ...
                        <tbody><!-- tbody begin -->
                            ...
                            <?php 
                                ...
                                while($row_users=mysqli_fetch_array($run_users)){
                                    ...
                                    $user_id = $row_users['AdminID'];
                                    
                                    $user_name = $row_users['AdminName'];
                                    
                                    $user_img = $row_users['AdminImg'];
                                    
                                    $user_email = $row_users['AdminEmail'];
